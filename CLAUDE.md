...
**Разработчик:** Claude Code + Kayotova
...
```
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
```

**Использование:**
```bash
# Настройка для push
git remote set-url origin https://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@github.com/ymka_kayotova/lingo-mingle.git
```
...
git remote set-url origin https://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@github.com/<username>/lingo-mingle.git
...
# Password: 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
```
